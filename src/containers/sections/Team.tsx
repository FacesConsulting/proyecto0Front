import SubscribeForm from '@/components/form/subscribe/SubscribeForm'
import React from 'react'

const Team = () => {
  return (
    <section className='bg-sky-950 text-white text-center py-16'>
      <div className='flex flex-wrap justify-center'>
        <div className='grow-0 shrink-0 flex-basis w-full lg:w-6/12 px-3'>
          ...
          <p className='text-gray-100 mb-12'>
            ...
            tempora itaque necessitatibus, molestiae dolorem reprehenderit unde,
            delectus nobis culpa officia quidem ipsam tempore, a commodi saepe
            odio cum voluptatem assumenda.
          </p>
